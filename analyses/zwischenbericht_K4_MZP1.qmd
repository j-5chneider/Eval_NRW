...
k3_laa <- rio::import(here("data/LAA_K3_110424.sav")) # K3 der LAA MZP 1 und MZP 2
k3_alk_mzp1 <- rio::import(here("data/01_Datensatz_ALK_MZP1_040422_lokaleCodierung.sav")) # K3 der ALK MZP 1
k3_sab_mzp1 <- rio::import(here("data/01_Datensatz_SAB_MZP1_200422.sav")) # K3 der SAB MZP 1
k3_sab_mzp2 <- rio::import(here("data/01_Datensatz_SAB_MZP2_4.4.22.sav")) # K3 der SAB MZP 2
...
```{r}
k3_sab_mzp2 %>%
  dplyr::mutate(zszf_4k_02_agree = ifelse(zszf_4k_02 >= 3, 1, 0)) %>%
  dplyr::summarise(zszf_4k_02_agree = mean(zszf_4k_02_agree, na.rm = T))


k3_laa %>%
  dplyr::mutate(zszf_4k_agree = ifelse(zszf_4_02 >= 3, 1, 0)) %>%
  dplyr::summarise(zszf_4k_agree = mean(zszf_4k_agree, na.rm = T))
```
