...
**ANOVA**  
Enthusiasmus unterrichten: K1 vs. K2 vs. K3 vs. K4
```{r}
...
**ANOVA**  
Enthusiasmus Fach: K1 vs. K2 vs. K3 vs. K4
```{r}
...
**t-Test**  
Reflektionsbereitschaft: K3 vs. K4
```{r}
t.test(rfbe ~ kohorte, 
       data = nrw |> dplyr::filter(kohorte %in% c("3", "4") & 
                                   gruppe %in% c("laa")))
...
rm(nrw_p)
nrw_p <- nrw |>
  dplyr::filter(kohorte %in% c("1", "2", "4")) |>
